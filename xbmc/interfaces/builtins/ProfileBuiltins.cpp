...
CBuiltins::CommandMap CProfileBuiltins::GetOperations() const
{
  ...
  commands.insert(std::make_pair("mastermode", builtin2));

  CBuiltins::BUILT_IN builtin3 = {"Log off current user", 0, LogOff};
  commands.insert(std::make_pair("system.logoff", builtin3));
